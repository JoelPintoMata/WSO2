   ...
   public RDBMS_Proxy_YenloStub(org.apache.axis2.context.ConfigurationContext configurationContext,
    ...
    public RDBMS_Proxy_YenloStub(java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
        this(null,targetEndpoint);
                     ...
                     */
                            ...
                            public  rdbms_service_stub.Product[] products(
              ...
              org.apache.axiom.soap.SOAPEnvelope env = null;
                    rdbms_service_stub.Products2 dummyWrappedType = null;
               ...
               org.apache.axis2.context.MessageContext _returnMessageContext = _operationClient.getMessageContext(
                ...
                org.apache.axiom.soap.SOAPEnvelope _returnEnv = _returnMessageContext.getEnvelope();
                                ...
                                java.lang.Object object = fromOM(
                                             ...
                                             rdbms_service_stub.ProductsE.class,
                                              getEnvelopeNamespaces(_returnEnv));

                               
                                        return getProductsProduct((rdbms_service_stub.ProductsE)object);
                            ...
                            try {
                                org.apache.axiom.soap.SOAPEnvelope resultEnv = resultContext.getEnvelope();
                                        ...
                                        callback.receiveResultproducts(
                                            getProductsProduct((rdbms_service_stub.ProductsE)object));
        ...
        if ( _operations[0].getMessageReceiver()==null &&  _operationClient.getOptions().isUseSeparateListener()) {
          ...
          _operations[0].setMessageReceiver(
           ...
           _operationClient.execute(false);
              ...
              // create SOAP envelope with that payload
              org.apache.axiom.soap.SOAPEnvelope env = null;
                    rdbms_service_stub.UpdateProductStock dummyWrappedType = null;
                                                    env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()),
                                                    sTOCK39,
                                                    iD40,
                                                    dummyWrappedType,
           ...
           _operationClient.execute(false);
                ...
                org.apache.axiom.soap.SOAPEnvelope env = null;
                 _messageContext = new org.apache.axis2.context.MessageContext();
                                                    ...
                                                    //Style is Doc.
                                                    rdbms_service_stub.DeleteAllProducts dummyWrappedType = null;
                                                                    env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()),
                                                                    dummyWrappedType,
                                                                    optimizeContent(new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample_yenlo",
                                                                    "deleteAllProducts")));
         ...
         _serviceClient.addHeadersToEnvelope(env);
            ...
            _operationClient.addMessageContext(_messageContext);
             ...
             return;
              ...
              // create SOAP envelope with that payload
              org.apache.axiom.soap.SOAPEnvelope env = null;
                    rdbms_service_stub.Begin_boxcar dummyWrappedType = null;
                                                    env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()),
                                                    dummyWrappedType,
                                                    optimizeContent(new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample_yenlo",
                                                    "begin_boxcar")));
          ...
          _operations[3].setMessageReceiver(
           ...
           _operationClient.execute(false);
                     ...
                     */
                            ...
                            public  rdbms_service_stub.Product[] productsByName(
              ...
              // create SOAP envelope with that payload
              org.apache.axiom.soap.SOAPEnvelope env = null;
                    rdbms_service_stub.ProductsByName dummyWrappedType = null;
                                                    env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()),
                                                    nAME48,
                                                    dummyWrappedType,
                                                    optimizeContent(new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample_yenlo",
        ...
        if ( _operations[4].getMessageReceiver()==null &&  _operationClient.getOptions().isUseSeparateListener()) {
          ...
          _operations[4].setMessageReceiver(
           ...
           _operationClient.execute(false);
              ...
              // create SOAP envelope with that payload
              org.apache.axiom.soap.SOAPEnvelope env = null;
                    rdbms_service_stub.End_boxcar dummyWrappedType = null;
                                                    env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()),
                                                    dummyWrappedType,
                                                    optimizeContent(new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample_yenlo",
                                                    "end_boxcar")));
        ...
        if ( _operations[5].getMessageReceiver()==null &&  _operationClient.getOptions().isUseSeparateListener()) {
          ...
          _operations[5].setMessageReceiver(
           ...
           _operationClient.execute(false);
              ...
              // create SOAP envelope with that payload
              org.apache.axiom.soap.SOAPEnvelope env = null;
                    rdbms_service_stub.InsertProduct dummyWrappedType = null;
                                                    env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()),
                                                    nAME55,
                                                    dESCRIPTION56,
                                                    sTOCK57,
           ...
           _operationClient.execute(false);
                ...
                org.apache.axiom.soap.SOAPEnvelope env = null;
                 _messageContext = new org.apache.axis2.context.MessageContext();
                                                    ...
                                                    //Style is Doc.
                                                    rdbms_service_stub.Abort_boxcar dummyWrappedType = null;
                                                                    env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()),
                                                                    dummyWrappedType,
                                                                    optimizeContent(new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample_yenlo",
                                                                    "abort_boxcar")));
    ...
    private boolean optimizeContent(javax.xml.namespace.QName opName) {
     ...
     //http://Joels-MacBook-Air.local:8283/services/RDBMS_Proxy_Yenlo.RDBMS_Proxy_YenloHttpSoap12Endpoint
            private  org.apache.axiom.om.OMElement  toOM(rdbms_service_stub.Products2 param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(rdbms_service_stub.Products2.MY_QNAME,
            ...
            private  org.apache.axiom.om.OMElement  toOM(rdbms_service_stub.ProductsE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(rdbms_service_stub.ProductsE.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(rdbms_service_stub.UpdateProductStock param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(rdbms_service_stub.UpdateProductStock.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(rdbms_service_stub.DeleteAllProducts param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(rdbms_service_stub.DeleteAllProducts.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(rdbms_service_stub.Begin_boxcar param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(rdbms_service_stub.Begin_boxcar.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(rdbms_service_stub.ProductsByName param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(rdbms_service_stub.ProductsByName.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(rdbms_service_stub.End_boxcar param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(rdbms_service_stub.End_boxcar.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(rdbms_service_stub.InsertProduct param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(rdbms_service_stub.InsertProduct.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(rdbms_service_stub.Abort_boxcar param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(rdbms_service_stub.Abort_boxcar.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
                                ...
                                private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                    rdbms_service_stub.Products2 dummyWrappedType,
                                 boolean optimizeContent) throws org.apache.axis2.AxisFault{

                                try{
                                rdbms_service_stub.Products2 wrappedType = new rdbms_service_stub.Products2();

                                 

                               org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                  
                                        emptyEnvelope.getBody().addChild(wrappedType.getOMElement(rdbms_service_stub.Products2.MY_QNAME,factory));
                             ...
                             /* methods to provide back word compatibility */
                                ...
                                private rdbms_service_stub.Product[] getProductsProduct(
                                rdbms_service_stub.ProductsE wrappedType){
                                ...
                                private rdbms_service_stub.Products getproducts(
                                rdbms_service_stub.ProductsE wrappedType){
                                ...
                                private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                    int param1,
                                    int param2,
                                    rdbms_service_stub.UpdateProductStock dummyWrappedType,
                                 boolean optimizeContent) throws org.apache.axis2.AxisFault{

                                try{
                                rdbms_service_stub.UpdateProductStock wrappedType = new rdbms_service_stub.UpdateProductStock();
                               ...
                               org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                        ...
                                        emptyEnvelope.getBody().addChild(wrappedType.getOMElement(rdbms_service_stub.UpdateProductStock.MY_QNAME,factory));
                             ...
                             /* methods to provide back word compatibility */
                                ...
                                private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                    rdbms_service_stub.DeleteAllProducts dummyWrappedType,
                                 boolean optimizeContent) throws org.apache.axis2.AxisFault{

                                try{
                                rdbms_service_stub.DeleteAllProducts wrappedType = new rdbms_service_stub.DeleteAllProducts();

                                 

                               org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                  
                                        emptyEnvelope.getBody().addChild(wrappedType.getOMElement(rdbms_service_stub.DeleteAllProducts.MY_QNAME,factory));
                             ...
                             /* methods to provide back word compatibility */
                                ...
                                private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                    rdbms_service_stub.Begin_boxcar dummyWrappedType,
                                 boolean optimizeContent) throws org.apache.axis2.AxisFault{

                                try{
                                rdbms_service_stub.Begin_boxcar wrappedType = new rdbms_service_stub.Begin_boxcar();

                                 

                               org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                  
                                        emptyEnvelope.getBody().addChild(wrappedType.getOMElement(rdbms_service_stub.Begin_boxcar.MY_QNAME,factory));
                             ...
                             /* methods to provide back word compatibility */
                                ...
                                private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                    ...
                                    rdbms_service_stub.ProductsByName dummyWrappedType,
                                 boolean optimizeContent) throws org.apache.axis2.AxisFault{

                                try{
                                rdbms_service_stub.ProductsByName wrappedType = new rdbms_service_stub.ProductsByName();
                               ...
                               org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                        ...
                                        emptyEnvelope.getBody().addChild(wrappedType.getOMElement(rdbms_service_stub.ProductsByName.MY_QNAME,factory));
                             ...
                             /* methods to provide back word compatibility */
                                ...
                                private rdbms_service_stub.Products getproductsByName(
                                rdbms_service_stub.ProductsE wrappedType){
                                    return wrappedType.getProducts();
                                }
                                ...
                                private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                    ...
                                    int param3,
                                    rdbms_service_stub.InsertProduct dummyWrappedType,
                                 boolean optimizeContent) throws org.apache.axis2.AxisFault{

                                try{
                                rdbms_service_stub.InsertProduct wrappedType = new rdbms_service_stub.InsertProduct();
                               ...
                               org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                        ...
                                        emptyEnvelope.getBody().addChild(wrappedType.getOMElement(rdbms_service_stub.InsertProduct.MY_QNAME,factory));
                             ...
                             /* methods to provide back word compatibility */
                                ...
                                private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                    rdbms_service_stub.End_boxcar dummyWrappedType,
                                 boolean optimizeContent) throws org.apache.axis2.AxisFault{

                                try{
                                rdbms_service_stub.End_boxcar wrappedType = new rdbms_service_stub.End_boxcar();

                                 

                               org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                  
                                        emptyEnvelope.getBody().addChild(wrappedType.getOMElement(rdbms_service_stub.End_boxcar.MY_QNAME,factory));
                             ...
                             /* methods to provide back word compatibility */
                                ...
                                private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
                                    rdbms_service_stub.Abort_boxcar dummyWrappedType,
                                 boolean optimizeContent) throws org.apache.axis2.AxisFault{

                                try{
                                rdbms_service_stub.Abort_boxcar wrappedType = new rdbms_service_stub.Abort_boxcar();

                                 

                               org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                                  
                                        emptyEnvelope.getBody().addChild(wrappedType.getOMElement(rdbms_service_stub.Abort_boxcar.MY_QNAME,factory));
        ...
        */
        ...
        try {
                ...
                if (rdbms_service_stub.Products2.class.equals(type)){
                
                           return rdbms_service_stub.Products2.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (rdbms_service_stub.ProductsE.class.equals(type)){
                
                           return rdbms_service_stub.ProductsE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                ...
                if (rdbms_service_stub.UpdateProductStock.class.equals(type)){
                
                           return rdbms_service_stub.UpdateProductStock.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                ...
                if (rdbms_service_stub.DeleteAllProducts.class.equals(type)){
                
                           return rdbms_service_stub.DeleteAllProducts.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (rdbms_service_stub.Begin_boxcar.class.equals(type)){
                
                           return rdbms_service_stub.Begin_boxcar.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                ...
                if (rdbms_service_stub.ProductsByName.class.equals(type)){
                
                           return rdbms_service_stub.ProductsByName.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                ...
                if (rdbms_service_stub.End_boxcar.class.equals(type)){
                
                           return rdbms_service_stub.End_boxcar.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                ...
                if (rdbms_service_stub.InsertProduct.class.equals(type)){
                
                           return rdbms_service_stub.InsertProduct.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                ...
                if (rdbms_service_stub.Abort_boxcar.class.equals(type)){
                
                           return rdbms_service_stub.Abort_boxcar.Factory.parse(param.getXMLStreamReaderWithoutCaching());
